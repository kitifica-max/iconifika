      ...
      >
        ...
        {current > 0 && (
          <button
            ...
            className="absolute left-2 top-1/2 -translate-y-1/2 z-50 text-white select-none opacity-70 hover:opacity-100 active:scale-90 active:opacity-60 transition-all duration-150"
            aria-label="Anterior"
          >
        ...
        {current < slides.length - 1 && (
          <button
            onClick={() => goTo(current + 1)}
            className="absolute right-2 top-1/2 -translate-y-1/2 z-50 text-white select-none opacity-70 hover:opacity-100 active:scale-90 active:opacity-60 transition-all duration-150"
